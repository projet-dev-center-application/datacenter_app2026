...
<body class="container mt-5">
    <div class="card shadow">
        <div class="card-header bg-warning text-dark">
            <h2>Modifier la ressource : {{ $resource->name }}</h2>
        </div>
        <div class="card-body">
            <form action="/resources/update/{{ $resource->id }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nom" value="{{ $resource->name }}" class="form-control" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="emplacement" value="{{ $resource->location }}" class="form-control" required>
                </div>
